!(function (e) {
	...
	(e.FileDialog = function (a) {
		var o = e.extend(e.FileDialog.defaults, a),
			t = e(
				[
					...
					"                <button type='button' class='btn btn-dark bfd-ok'>",
					o.ok_button,
					"                </button>",
			...
			c = function (a) {
				...
				var s = e(
					[
						...
						"    <span class='bfd-remove'><i class='fas fa-times'></i></span>&nbsp;",
						"    <span><i class='fas fa-file'></i></span>&nbsp;" +
							a.name,
						"</div>",
						"<div class='col-xs-5 col-sm-8 bfd-progress'>",
						"    <div class='progress'>",
						"        <div class='progress-bar bg-dark progress-bar-striped progress-bar-animated active' role='progressbar'",
		...
		(e.FileDialog.defaults = {
			...
			title: "Upload Course related files here",
		});
})(jQuery);
